...
def SSD300(input_shape, num_classes=21):
    ...
    net['conv1_2'] = Convolution2D(64, (3, 3),
                                   ...
                                   name='conv1_2',
                                   padding='same')
    net['pool1'] = MaxPooling2D((2, 2), strides=(2, 2),
    ...
    net['conv3_3'] = Convolution2D(256, (3, 3),
                                   ...
                                   name='conv3_3',
                                   padding='same')
    net['pool3'] = MaxPooling2D((2, 2), strides=(2, 2),
                                name='pool3', padding='same')
    # Block 4
    ...
    net['conv5_3'] = Convolution2D(512, (3, 3),
                                   ...
                                   name='conv5_3',
                                   padding='same')
    net['pool5'] = MaxPooling2D((3, 3), strides=(1, 1),
                                name='pool5', padding='same')
    # FC6
    ...
    num_priors = 6
    x = Convolution2D(num_priors * 4, (3, 3), paddinge='same',
